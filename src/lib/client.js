...
export class VisaHttpClient {
  ...
  async book(headers, scheduleId, facilityId, date, time, facilityIdAsc = '', dateAsc = '', timeAsc = '') {
    ...
    const bookingData = {
      ...
      'appointments[asc_appointment][facility_id]': facilityIdAsc,
      'appointments[asc_appointment][date]': dateAsc,
      'appointments[asc_appointment][time]': timeAsc
    };
